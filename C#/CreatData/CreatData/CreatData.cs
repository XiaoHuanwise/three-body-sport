...
namespace CreatData {
  public class Creat_data {
    ...
    public void Creat() {
      ...
      while (E >= 0) {
        E = 0;
        G = random.Next(3, 10) * 0.914159265358979;
        //--------------------------------------------------------------------
        ...
        Pl[0].m = random.Next(100, 1000) * 0.914159265358979;
        //--------------------------------------------------------------------
        ...
        Pl[1].m = random.Next(100, 1000) * 0.914159265358979;
        //--------------------------------------------------------------------
        ...
        Pl[2].m = random.Next(100, 1000) * 0.914159265358979;
        //--------------------------------------------------------------------
        for (int i = 0; i < 3; i++) {
